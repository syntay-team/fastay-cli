...
export function buildProject(config, root) {
    return __awaiter(this, void 0, void 0, function () {
        var outDir, projectTsConfig, whatLanguage, projectEslint, projectEslintConfig, aliases, _i, _a, _b, alias, aliasPath, cleanAlias, resolvedPath, files, jsonFiles, _c, jsonFiles_1, file, srcPath, distPath, srcRoutes, distRoutes, fixScript, tempDir;
            ...
            switch (_k.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, esbuild.build({
                            ...
                            sourcemap: true,
                            treeShaking: (_e = (_d = config.compiler) === null || _d === void 0 ? void 0 : _d.treeShaking) !== null && _e !== void 0 ? _e : false,
                            legalComments: (_g = (_f = config.compiler) === null || _f === void 0 ? void 0 : _f.legalComments) !== null && _g !== void 0 ? _g : "none",
                            loader: whatLanguage === "ts" ? { ".ts": "ts" } : { ".js": "js" },
                            target: (_j = (_h = config.compiler) === null || _h === void 0 ? void 0 : _h.target) !== null && _j !== void 0 ? _j : "es2020",
                            logLevel: "info",
                        })];
                case 2:
                    _k.sent();
                    Logger.buildStep("Copying JSON assets...");
                    return [4 /*yield*/, glob("src/**/*.json", { cwd: root })];
                case 3:
                    jsonFiles = _k.sent();
                    for (_c = 0, jsonFiles_1 = jsonFiles; _c < jsonFiles_1.length; _c++) {
                        file = jsonFiles_1[_c];
                        srcPath = path.join(root, file);
                        distPath = path.join(outDir, file.replace(/^src\//, ""));
